...
Мобильная часть проекта реализована как кроссплатформенное приложение под Android и iOS.

## ✅ Что реализовано

- Кроссплатформенное мобильное приложение для Android и iOS.
...
| Категория | Стек |
|---|---|
| Mobile | React Native, Redux, Android, iOS |
...
- Android: отладка и проверка сценариев проводились через Android Studio Emulator.
- iOS: приложение реализовано в кроссплатформенном формате React Native для поддержки iPhone.
